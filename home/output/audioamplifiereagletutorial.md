...
2. Load up a Design Rules Check (***DRC***) file. This file makes sure you’re following a set of rules about how far apart components are from each other, among other things. We will provide you with a  tad265 DRC file that is configured correctly for our PCB fabrication machine (PCB mill).  
- Download the tad265 DRC file: tad265 DRC. (Very very important!) and save the file to: "***Documents\EAGLE\design*** rules" in the Eagle Control Panel.
...
3. Connect components with ***copper wires***. Select “Route”  or go to “Edit-> Route”. Click and follow the yellow airwires to connect components (I am using 2 resistors as an example here; ***you should have 3 resistors***). 
<!---
Add eighth image
-->
4. DRC check. Open the DRC window again. Click “Check”. Make sure there is no error popped up. In the ***status bar***, you should see “DR4C: No errors.”
